...
sequenceDiagram
    ...
    Note over COND: count=10 >= 2×max_debate_rounds (实际) → Research Manager
...
sequenceDiagram
    ...
    Note over LLM: deepseek-reasoner<br/>绑定 Pydantic schema → 输出 JSON
...
sequenceDiagram
    ...
    Note over TR: prompt 包含: Research Plan 全文<br/>"0700.HK 需要用确切代码..."
